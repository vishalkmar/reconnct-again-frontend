// Fallback category-slug → audience-slug[] map (mirrors the app + the Reconnct
// taxonomy sheet). Used to filter broad categories by the selected audience when
// the backend category.audiences is empty. The taxonomy value wins when present.
