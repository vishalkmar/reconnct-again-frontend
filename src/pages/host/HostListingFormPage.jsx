    ...
    <Card>
      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <L>Pincode</L>
            <input className="win" value={form.pincode} onChange={(e) => patch({ pincode: e.target.value.replace(/[^0-9]/g, '').slice(0, 6) })} placeholder="e.g. 403516" inputMode="numeric" maxLength={6} />
          </div>
        </div>
        <div>
          <L>Duration</L>
