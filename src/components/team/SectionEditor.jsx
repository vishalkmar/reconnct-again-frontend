      ...
      return (
        <div className="space-y-6">
          ...
          <div className="pt-4 border-t border-gray-100">
            ...
            <ExperienceTaxPricing gstRate={draft.gstRate} markup={draft.markup} discount={draft.discount} convenienceFee={draft.convenienceFee} basePrice={draft.pricing?.adultPrice || 0} experienceIds={exp?.id ? [exp.id] : []} onChange={patch} />
          </div>
        </div>
      );
    case 'duration':
